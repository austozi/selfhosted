...
[Mealie](https://www.github.com/hay-kot/mealie) is a recipe manager. The official Docker Hub repository provides images for amd64 and arm64. My attempts to build an arm image failed with some error about Poetry, which I was never able to covercome.
