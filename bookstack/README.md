...
First, read the upstream project's [security guide](https://www.bookstackapp.com/docs/admin/security/), including enforcing two-factor authentication (2FA). The following notes describe the adaptations using the [SWAG container](https://github.com/linuxserver/docker-swag) as the reverse proxy.
